...
namespace FinalExamBackEnd.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstName,Mail,HireDate,Manager_ID,Department_ID")] Staff staff)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(staffToUpdate, "",
               new string[] { "ID", "LastName","FirstName","Mail","HireDate","Manager_ID","Department_ID" }))
            {
                try
                {
                    db.SaveChanges();
        ...
        private void PopulateDepartmentsDropDownList(object selectedDepartment = null)
        {
            var departmentsQuery = from d in db.Departments
                                   orderby d.DepName
                                   select d;
            ViewBag.ID = new SelectList(departmentsQuery, "ID", "DepName", selectedDepartment);
        } 
